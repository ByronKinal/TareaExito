...
call sp_AgregarProducto('Maus','2.00',30,'10001');
call sp_AgregarProducto('Teclado','1.00',30,'10002');
call sp_AgregarProducto('Audifonos con cable','30.00',30,'10003');
call sp_AgregarProducto('Audifonos sin cable','3.00',30,'10004');
call sp_AgregarProducto('Cascos','2.00',30,'10005');
call sp_AgregarProducto('Carnasa de Telefono','3.5',30,'10006');
call sp_AgregarProducto('Cable HDMI','2.5',30,'10007');
call sp_AgregarProducto('Cable USB','1.00',30,'10008');
call sp_AgregarProducto('Cargador Tipo c','1.00',30,'10009');
